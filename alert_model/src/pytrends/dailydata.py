...
def get_daily_data(word: str,
    ...
    """Given a word, fetches daily search volume data_folder from Google Trends and
    returns results in a pandas DataFrame.

    Details: Due to the way Google Trends scales and returns data_folder, special
